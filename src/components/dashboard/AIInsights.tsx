...
export function AIInsights({ insights, onAskAdvisor }: AIInsightsProps) {
  ...
  return (
    <div className="bg-slate-800 rounded-lg p-4 text-white h-full flex flex-col">
      {/* Header */}
      ...
      <button
        ...
        className="mt-4 w-full bg-[#c2703e] hover:bg-[#a85d32] text-white font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center gap-2"
      >
